...
export const Tabs: React.FC<TabsProps> = ({ activeTab, setActiveTab }) => {
  const getTabClass = (tab: Tab) => {
    const baseClass = "px-1.5 sm:px-2.5 py-1 sm:py-1.5 text-[10px] sm:text-xs font-medium transition-colors duration-200 cursor-pointer focus:outline-none whitespace-nowrap flex-shrink-0";
    if (tab === activeTab) {
