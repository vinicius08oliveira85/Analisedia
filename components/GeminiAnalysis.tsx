...
const AnalysisDisplay: React.FC<{ analysis: string }> = ({ analysis }) => (
    <div className="text-gray-300 bg-gray-900/50 p-6 rounded-lg whitespace-pre-wrap font-sans leading-relaxed text-left">
        {analysis}
    </div>
);
                ...
                {!isLoading && !analysis && !error && (
                    <>
                        ...
                        <button
                            ...
                            className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg transition-transform duration-200 hover:scale-105 shadow-lg flex items-center justify-center mx-auto"
                        >
