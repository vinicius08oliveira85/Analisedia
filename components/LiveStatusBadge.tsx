    ...
    <div className="flex flex-col gap-1 sm:gap-1.5">
      ...
      {liveStatus && (
        <div className="flex flex-col gap-0.5 sm:gap-1">
          ...
          <div className="flex items-center gap-1 sm:gap-1.5 justify-center">
            {liveStatus.isLive && (
              <div className="flex items-center gap-0.5 sm:gap-1">
                ...
                {liveStatus.minute !== undefined && (
                  <span className="text-[9px] sm:text-[10px] font-bold text-white bg-red-600/30 px-1 rounded">
                    {liveStatus.minute}'
                  </span>
                )}
              </div>
          ...
          {/* Linha 2: Placar (sempre visível se houver scores) */}
          {liveStatus.homeScore !== undefined && liveStatus.awayScore !== undefined && (
            <div className="flex items-center justify-center">
              <span className="text-sm sm:text-base font-bold text-white bg-gray-700/50 px-2 py-0.5 rounded">
